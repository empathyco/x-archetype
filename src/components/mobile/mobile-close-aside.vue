<template>
  <div class="xds:mx-16 xds:flex xds:gap-16 xds:border-t xds:border-neutral-10 xds:py-24">
    <ClearFilters
      v-slot="{ selectedFilters }"
      class="xds:flex-auto xds:button-outlined xds:button-lead xds:py-12 xds:uppercase"
      :always-visible="false"
    >
      {{ $t('selectedFilters.clear', selectedFilters.length, { count: selectedFilters.length }) }}
    </ClearFilters>
    <BaseIdModalClose
      class="xds:flex-auto xds:button-lead xds:py-12 xds:uppercase"
