<template>
  ...
  >
    ...
    <slot name="add-to-cart">
      <BaseAddToCart
        :result="result"
        class="xds:mt-auto xds:button xds:max-h-40 xds:flex-auto xds:border-none xds:bg-neutral-50 xds:text-md xds:font-regular xds:text-neutral-0 xds:hover:bg-neutral-25"
      >
        {{ $t('result.addToCart') }}
      </BaseAddToCart>
    </slot>
