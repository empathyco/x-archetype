...
### 1. [Project Overview](./copilot-instructions/01-project-overview.md)
...
### 2. [Architecture](./copilot-instructions/02-architecture.md)

Core integration patterns, adapter system, component architecture, and state management using X Components and Vuex.

### 3. [Vue & TypeScript](./copilot-instructions/03-vue-typescript.md)
...
### 4. [Design & Tailwind](./copilot-instructions/04-design-tailwind.md)
...
### 5. [Figma MCP Workflow](./copilot-instructions/05-figma-workflow.md)
...
### 10. [Common Pitfalls](./copilot-instructions/10-common-pitfalls.md)
...
### 11. [Project Conventions](./copilot-instructions/11-project-conventions.md)
...
1. Read [Project Overview](./copilot-instructions/01-project-overview.md) for context
2. Review [Common Pitfalls](./copilot-instructions/10-common-pitfalls.md) to avoid frequent mistakes
3. Reference specialized documents as needed for specific tasks

### For Specific Tasks

- **Implementing UI from Figma**: [Figma MCP Workflow](./copilot-instructions/05-figma-workflow.md) → [Design & Tailwind](./copilot-instructions/04-design-tailwind.md)
- **Adding search features**: [X Components Integration](./copilot-instructions/07-x-components-integration.md) → [Architecture](./copilot-instructions/02-architecture.md)
- **Fixing responsive issues**: [Design & Tailwind - Device Breakpoints](./copilot-instructions/04-design-tailwind.md#critical-device-breakpoints-synchronization)
- **Setting up development**: [Development Workflows](./copilot-instructions/06-development-workflows.md)
- **Extending types**: [Vue & TypeScript](./copilot-instructions/03-vue-typescript.md)
- **Customizing wiring**: [X Components Integration](./copilot-instructions/07-x-components-integration.md)
